...
public class Jeu {
    ...
    public void menu(Systeme s, String etat, int ressourcesOK, long score) {
        ...
        if (etat == "orbitePlanete0")
            ...
            System.out.println("(1) Recolter ressources sur: " + s.getSysteme()[0].toString());
        else
        ...
        if (etat == "orbitePlanete1")
            ...
            System.out.println("(2) Recolter ressources sur: " + s.getSysteme()[1].toString());
        ...
        if (etat == "orbitePlanete2")
            ...
            System.out.println("(3) Recolter ressources sur: " + s.getSysteme()[2].toString());
        ...
        if (etat == "orbitePlanete3")
            ...
            System.out.println("(4) Recolter ressources sur: " + s.getSysteme()[3].toString());
    ...
    public void menuJeu() {
        ...
        if (saisie == 2) {
            System.out.println("Ce jeu est très largement inspiré du jeu déjà existant OutThere.\n" +
                    "Le principe est simple, vous êtes un explorateur humain en cyogénisation depuis des décennies \n" +
                    "et vous vous réveillez à bord de votre vaisseau, prêt à découvrir l'espace.\n" +
                    "Le principe du jeu est simple, vous avez trois jauges caractérisant la coque du vaisseau, le niveau d'oxygène et le réservoir de carburant.\n" +
                    "Si l'une d'elle atteint 0 lors d'une action, vous pourrez tenté une action desespérée et peut être survivre, le cas échéant, ce sera la fin du jeu.\n" +
                    "Pour récolter des ressources, vous pouvez explorer les différents planètes\n" +
                    "Les ressources récoltées peuvent être utilisées pour augmenter vos différentes jauges et se trouve dans la soute du vaisseau\n\n" +
                    "Précision sur les types de ressources!\n" +
                    ...
                    "- L'hydrogène et l'hélium se trouvent sur les géantes gazeuze, vous remplirez votre réservoir de carburant en les utilisant\n" +
                    "- Le fer et le titane se trouvent sur les planètes minières et servent a réparer votre coque\n");
